function Footer() {
  return (
    <footer className="border-t bg-gray-100 mt-auto w-full py-10 px-4 sm:px-6 lg:px-8 mx-auto">
  <div className="text-center">
    <div className="mt-3">
      <p className="text-gray-500">Made with ❤️ by <a className="text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium" href="#">Sonu Hansda</a></p>
