function Contact() {
    return (
        <div className="overflow-hidden">
            <div className="max-w-[85rem] mx-auto  sm:px-6 py-20">
                <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
                    <div className="text-center">
                        ...
                        Bringing your vision to life, <span className="text-lime-500">frame by frame.</span>
                        </h1>
                    </div>
                    ...
                    <form>
                        <div className="mx-auto max-w-2xl sm:flex sm:space-x-3 p-3 bg-white border rounded-lg shadow-lg shadow-gray-100">
                            <div className="w-full pb-2 sm:pb-0">
                                ...
                                <input type="text" id="hs-hero-name-1" className="py-3 px-4 block w-full border border-gray-200 rounded-lg text-sm focus:border-lime-500 focus:ring-lime-500" placeholder="Your name" />
                            </div>
                            <div className="w-full pb-2 sm:pb-0">
                                <label htmlFor="hs-hero-email-1" className="block text-sm font-medium"><span className="sr-only">Your Email</span></label>
                                <input type="text" id="hs-hero-email-1" className="py-3 px-4 block w-full border border-gray-200 rounded-lg text-sm focus:border-lime-500 focus:ring-lime-500" placeholder="Your Email" />
                            </div>
                            <div className="whitespace-nowrap pt-2 sm:pt-0 grid sm:block">
                                <a className="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-lime-600 text-white hover:bg-lime-700 focus:outline-none focus:bg-lime-700 disabled:opacity-50 disabled:pointer-events-none" href="#">
                                    Book Appointment
                                </a>
                            </div>
                        </div>
